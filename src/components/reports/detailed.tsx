...
import { performanceBy, totalPnl, groupBy } from "@/lib/analytics";
...
export function ReportsDetailed({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Section 3: Per-asset equity curves -------------------------------- */}
      <section>
        <SectionHeader title="Asset performance" subtitle="Per-symbol equity" />
