    ...
    >
      ...
      <div
        className={cn(
          ...
          collapsed ? "justify-center gap-0 px-0" : "gap-1 px-4"
        )}
      >
        <LogoMark className="h-11 shrink-0" />
        {!collapsed && <Wordmark size="sm" className="-ml-0.5 shrink-0" />}
      </div>
          ...
          if (item.primary) {
            return (
              <Link
                ...
                className={cn(
                  "mb-3 flex h-10 items-center gap-2 rounded-xl bg-brand-gradient text-sm font-medium text-white shadow-brand-glow hover:bg-brand-gradient-hover",
