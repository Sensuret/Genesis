      ...
      <div className="w-full max-w-md rounded-2xl border border-line bg-bg-elevated/80 p-8 shadow-card backdrop-blur">
        ...
        {done ? (
          <div className="space-y-4 text-center">
            ...
            <Link href="/login" className="text-sm text-sky-400 hover:text-violet-300 hover:underline">
              Continue to sign in
            </Link>
          </div>
        ) : !ready ? (
          <div className="space-y-3 text-center text-sm text-fg-muted">
            ...
            <Link href="/forgot-password" className="text-sky-400 hover:text-violet-300 hover:underline">
              Request a new link
            </Link>
          </div>
        ) : (
