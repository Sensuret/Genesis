    ...
    <div className="relative flex min-h-screen items-center justify-center bg-bg p-6">
      ...
      <div className="w-full max-w-md rounded-2xl border border-line bg-bg-elevated/80 p-8 shadow-card backdrop-blur">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-4 text-sm text-fg-muted">Create your account and start journaling.</p>
        </div>
          ...
          <form onSubmit={verifyOtp} className="space-y-4" noValidate>
            ...
            <div className="flex items-center justify-between text-xs text-fg-muted">
              <button
                ...
                onClick={resendOtp}
                disabled={verifying}
                className="text-sky-400 hover:text-violet-300 hover:underline disabled:opacity-60"
              >
                Resend code
              </button>
              <button
        ...
        <p className="mt-6 text-center text-sm text-fg-muted">
          ...
          <Link className="text-sky-400 hover:text-violet-300 hover:underline" href="/login">
            Sign in
          </Link>
        </p>
      </div>
